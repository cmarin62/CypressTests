describe('Galaxy Tab S4', function() {
    beforeEach(() => {
        cy.viewport(712, 970)
        cy.visit('https://staging.vashi.com/engagement-rings/')
    ...
    it('checks if displays the mobile menu', function() {
        ...
        it('Engagement Rings HERO Testing', ()=> {     
        
    
        //container
        cy.get('.alignment-left')
            .should('be.visible')
            .scrollIntoView()
        ...
        cy.get('.widget__head > p').eq(0)
            .should('be.visible')
            .scrollIntoView()
            .contains('Make your own ring, design one from scratch in-store, or choose from our handmade collection.')
        
        
        //check the background image URL of the first slider
        cy.get('.widget--hero').eq(0)
            .should('have.css', 'background-image', 'url("https://staging.vashi.com/skin/frontend/default/vashi/images/theme/cat-landing-page/hero/engagement-rings/hero.png")')
