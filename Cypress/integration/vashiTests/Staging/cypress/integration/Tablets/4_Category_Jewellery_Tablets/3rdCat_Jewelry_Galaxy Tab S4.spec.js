describe('Galaxy Tab S4', function() {
    beforeEach(() => {
        cy.viewport(712, 970)
        cy.visit('https://staging.vashi.com/jewellery/')
    ...
    it('checks if displays the mobile menu', function() {
        ...
        cy.get('.widget--hero').eq(0)
            .should('have.css', 'background-image', 'url("https://staging.vashi.com/skin/frontend/default/vashi/images/theme/cat-landing-page/hero/jewellery/mobile.png")')
