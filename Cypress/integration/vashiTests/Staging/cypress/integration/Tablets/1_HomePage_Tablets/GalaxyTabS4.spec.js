describe('Galaxy Tab S4', function() {
    ...
    cy.get('.widget__background').first()
        .should('have.css', 'background-image', 'url("https://staging.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero/slide1/Slide1_Ring_Mobile.png")')
    ...
    it('It takes two', ()=> {
        ...
        cy.get('.widget__background').eq(1)
            .should('have.css', 'background-image', 'url("https://staging.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero/slide2/Slide2_Ring_Mobile.png")')
    ...
    it('Find Inspiration', ()=> {
        ...
        cy.get('.widget__background').eq(2)
            .should('have.css', 'background-image', 'url("https://staging.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero/slide3/Slide3_Ring_Mobile.png")')
