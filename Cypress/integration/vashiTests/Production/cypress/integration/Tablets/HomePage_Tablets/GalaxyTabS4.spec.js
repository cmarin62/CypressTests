describe('Galaxy Tab S4', function() {
    ...
    cy.get('.slide ').eq(0)
        .should('be.visible')
        .scrollIntoView()
        .should('have.css', 'width', '695px')
        .and('have.css','height', '1120px')  
    ...
    cy.get('.widget__background').first()
        .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero/slide1/Slide1_Ring_Mobile.png")')
    ...
    it('It takes two', ()=> {
        ...
        cy.get('.widget__content').eq(1)
            .should('be.visible')
            .scrollIntoView()
            .should('have.css', 'width', '319px')
            .and('have.css','height', '87px')
        
        
        //check the background image URL of the 2nd slider
        cy.get('.widget__background').eq(1)
            .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero/slide2/Slide2_Ring_Mobile.png")')
    ...
    it('Find Inspiration', ()=> {
        ...
        cy.get('.widget__head').eq(2)
            .should('be.visible')
            .scrollIntoView()
            .should('have.css', 'width', '330px').and('have.css','height', '73px')
        ...
        cy.get('.widget__background').eq(2)
            .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero/slide3/Slide3_Ring_Mobile.png")')
    ...
    it('Engagement Rings block', ()=> {
        ...
        */
        ...
        cy.get('.no-content').eq(0)
        .scrollIntoView()
        .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero-single/hero.png")')
    ...
    it('Wedding Rings block', ()=> {
        ...
        */
        ...
        cy.get('.no-content').eq(1)
        .scrollIntoView()
        .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero-wedding-rings/hero.png")')
    ...
    it('Jewellery  block', ()=> {
        ...
        */
        ...
        cy.get('.no-content').eq(2)
        .scrollIntoView()
        .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/homepage-hero-jewellery/hero.png")')
