describe('iPhone 6 spec', function() {
    beforeEach(() => {
        ...
        cy.visit('https://www.vashi.com/engagement-rings/')
    ...
    it('checks if displays the mobile menu', function() {
        ...
        cy.get('.widget--hero').eq(0)
            .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/cat-landing-page/hero/engagement-rings/hero.png")')
