describe('iPhone 6 spec', function() {
    beforeEach(() => {
        ...
        cy.visit('https://www.vashi.com/wedding-rings/')
    ...
    it('checks if displays the mobile menu', function() {
        ...
        cy.get('.widget--hero').eq(0)
            .should('have.css', 'background-image', 'url("https://www.vashi.com/skin/frontend/default/vashi/images/theme/cat-landing-page/hero/wedding-rings/COP_WeddingRingx3.png")')
    ...
    it('Check font/css @DISCRETE PACKAGING paragraph', ()=>{     
     ...
     it('Check DISCRETE PACKAGING paragraphs  text', ()=>{     
