describe('iPad Air 2 pdp expensive"', function() {
    beforeEach(() => {
        cy.viewport('ipad-2')
    ...
    it('checks if displays the mobile menu', function() {
        ...
        it('tests the CSS / Dimenssions of the Product title, price, financing', ()=>{
            ...
            //Finance Form Button NOT DISPLAYED ANYMORE |Deprecated?!|
        ...
        it('clicks the <> buttons', ()=>{
            cy.get('.product__image__wrapper').eq(0)
            .trigger('mouseover')
            /*.scrollIntoView()
            .click()
            cy.wait(200)
        ...
        it('Logs in and PDP', ()=>{
            ...
            cy.get('.mobile-header .mobile-nav-toggler').click()
            cy.wait(500)
            cy.get('.js-click-acceptcookies').eq(0).click()
